defmodule EtlNumberOrderer.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: EtlNumberOrderer.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    EtlNumberOrdererWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
